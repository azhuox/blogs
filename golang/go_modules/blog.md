...
- Appended `v2` to the end of the module path (module `github.com/azhuox/blogs/golang/go_modules/example/module/v2`) as the latest version of the `module` package is `v2.0.1`.
